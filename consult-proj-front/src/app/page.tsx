    ...
    <>
      <QueryClientProvider client={queryClient}>
        ...
        <div className="relative bg-gray-50 dark:bg-gray-900 transition-colors duration-300 min-h-screen">
          <MapModal onClose={setMapOpen} isOpen={mapOpen} />
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="max-w-2xl">
                ...
                <p className="text-xl mb-8">
                  Exporting high-quality recycled cotton waste sourced from
                  garment manufacturing processes worldwide
                </p>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                  We specialize in exporting premium recycled cotton waste
                  sourced from ethical garment manufacturing processes across
                  India.
                </p>
              </div>
              <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow-sm">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Our recycled cotton waste is exported to clients worldwide
                    who value sustainable textile materials.
                  </p>
                </div>
                <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow-sm">
                  <div className="text-green-600 dark:text-green-400 text-4xl mb-4">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    ...
                    consistent fiber content and purity.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div className="bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-md">
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 mb-4">
                      High-quality cotton waste from t-shirt manufacturing
                      processes including cutting scraps and stitching waste.
                    </p>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-md">
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 mb-4">
                      Premium cotton waste from pants production including denim
          ...
          <section id="process" className="py-16 bg-white dark:bg-gray-800">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                  From garment waste to recycled material - our efficient
                  process ensures quality and sustainability
                </p>
              </div>
                ...
                <div className="space-y-8">
                  ...
                  <div className="flex flex-col md:flex-row items-center">
                    ...
                    <div className="md:ml-8 flex-1">
                      ...
                      <p className="text-gray-600 dark:text-gray-300">
                        ...
                        specializing in t-shirts, pants, and other clothing
                        items. This includes cutting scraps, stitching waste,
                  ...
                  <div className="flex flex-col md:flex-row items-center">
                    ...
                    <div className="md:ml-8 flex-1">
                      ...
                      <p className="text-gray-600 dark:text-gray-300">
                        Our team carefully sorts the collected waste by fabric
                        type, color, and quality to ensure we can provide
                        precisely the recycled cotton our clients need.
                      </p>
                    </div>
                  </div>
                  {/* Step 3 */}
                  <div className="flex flex-col md:flex-row items-center">
                    ...
                    <div className="md:ml-8 flex-1">
                      ...
                      <p className="text-gray-600 dark:text-gray-300">
                        ...
                        remove any impurities. We may further process the
                        material through shredding or other treatments as
                        required.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col md:flex-row items-center">
                    ...
                    <div className="md:ml-8 flex-1">
                      ...
                      <p className="text-gray-600 dark:text-gray-300">
                        ...
                        it meets our standards and client specifications before
                        packaging.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col md:flex-row items-center">
                    ...
                    <div className="md:ml-8 flex-1">
                      ...
                      <p className="text-gray-600 dark:text-gray-300">
                        The processed cotton waste is carefully packaged for
                        export, with all necessary documentation prepared to
